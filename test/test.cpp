...
BOOST_AUTO_TEST_CASE(ForwardLike) {
  // clang-format off
  static_assert(std::is_same_v<yk::copy_const_t<      int  ,       int  >,       int  >);
  static_assert(std::is_same_v<yk::copy_const_t<      int  ,       int& >,       int& >);
  static_assert(std::is_same_v<yk::copy_const_t<      int  ,       int&&>,       int&&>);
  static_assert(std::is_same_v<yk::copy_const_t<const int  ,       int  >, const int  >);
  static_assert(std::is_same_v<yk::copy_const_t<const int  ,       int& >,       int& >);
  static_assert(std::is_same_v<yk::copy_const_t<const int  ,       int&&>,       int&&>);
  static_assert(std::is_same_v<yk::copy_const_t<      int& ,       int  >,       int  >);
  static_assert(std::is_same_v<yk::copy_const_t<      int& ,       int& >,       int& >);
  static_assert(std::is_same_v<yk::copy_const_t<      int& ,       int&&>,       int&&>);
  ...
  static_assert(std::is_same_v<yk::copy_const_t<const int&&,       int& >,       int& >);
  static_assert(std::is_same_v<yk::copy_const_t<const int&&,       int&&>,       int&&>);
  static_assert(std::is_same_v<yk::copy_const_t<      int  , const int  >, const int  >);
  static_assert(std::is_same_v<yk::copy_const_t<      int  , const int& >, const int& >);
  static_assert(std::is_same_v<yk::copy_const_t<      int  , const int&&>, const int&&>);
  static_assert(std::is_same_v<yk::copy_const_t<const int  , const int  >, const int  >);
  static_assert(std::is_same_v<yk::copy_const_t<const int  , const int& >, const int& >);
  static_assert(std::is_same_v<yk::copy_const_t<const int  , const int&&>, const int&&>);
  static_assert(std::is_same_v<yk::copy_const_t<      int& , const int  >, const int  >);
  static_assert(std::is_same_v<yk::copy_const_t<      int& , const int& >, const int& >);
  ...
  static_assert(std::is_same_v<yk::override_ref_t<      int& ,       int  >,       int& >);
  static_assert(std::is_same_v<yk::override_ref_t<      int& ,       int& >,       int& >);
  static_assert(std::is_same_v<yk::override_ref_t<      int& ,       int&&>,       int& >);
  static_assert(std::is_same_v<yk::override_ref_t<const int& ,       int  >,       int& >);
  static_assert(std::is_same_v<yk::override_ref_t<const int& ,       int& >,       int& >);
  static_assert(std::is_same_v<yk::override_ref_t<const int& ,       int&&>,       int& >);
  static_assert(std::is_same_v<yk::override_ref_t<      int&&,       int  >,       int&&>);
  static_assert(std::is_same_v<yk::override_ref_t<      int&&,       int& >,       int&&>);
  ...
  static_assert(std::is_same_v<yk::override_ref_t<const int&&,       int& >,       int&&>);
  static_assert(std::is_same_v<yk::override_ref_t<const int&&,       int&&>,       int&&>);
  static_assert(std::is_same_v<yk::override_ref_t<      int& , const int  >, const int& >);
  static_assert(std::is_same_v<yk::override_ref_t<      int& , const int& >, const int& >);
  static_assert(std::is_same_v<yk::override_ref_t<      int& , const int&&>, const int& >);
  static_assert(std::is_same_v<yk::override_ref_t<const int& , const int  >, const int& >);
  static_assert(std::is_same_v<yk::override_ref_t<const int& , const int& >, const int& >);
  static_assert(std::is_same_v<yk::override_ref_t<const int& , const int&&>, const int& >);
  static_assert(std::is_same_v<yk::override_ref_t<      int&&, const int  >, const int&&>);
  static_assert(std::is_same_v<yk::override_ref_t<      int&&, const int& >, const int&&>);
  ...
  static_assert(std::is_same_v<yk::forward_like_t<const int&&,       int& >, const int&&>);
  static_assert(std::is_same_v<yk::forward_like_t<const int&&,       int&&>, const int&&>);
  static_assert(std::is_same_v<yk::forward_like_t<      int  , const int  >, const int&&>);
  static_assert(std::is_same_v<yk::forward_like_t<      int  , const int& >, const int&&>);
  static_assert(std::is_same_v<yk::forward_like_t<      int  , const int&&>, const int&&>);
  static_assert(std::is_same_v<yk::forward_like_t<const int  , const int  >, const int&&>);
  static_assert(std::is_same_v<yk::forward_like_t<const int  , const int& >, const int&&>);
  static_assert(std::is_same_v<yk::forward_like_t<const int  , const int&&>, const int&&>);
  static_assert(std::is_same_v<yk::forward_like_t<      int& , const int  >, const int& >);
  static_assert(std::is_same_v<yk::forward_like_t<      int& , const int& >, const int& >);
  ...
  static_assert(std::is_same_v<yk::forward_like_t<const int&&,       int& >, std_fwd_like_t<const int&&,       int& >>);
  static_assert(std::is_same_v<yk::forward_like_t<const int&&,       int&&>, std_fwd_like_t<const int&&,       int&&>>);
  static_assert(std::is_same_v<yk::forward_like_t<      int  , const int  >, std_fwd_like_t<      int  , const int  >>);
  static_assert(std::is_same_v<yk::forward_like_t<      int  , const int& >, std_fwd_like_t<      int  , const int& >>);
  static_assert(std::is_same_v<yk::forward_like_t<      int  , const int&&>, std_fwd_like_t<      int  , const int&&>>);
  static_assert(std::is_same_v<yk::forward_like_t<const int  , const int  >, std_fwd_like_t<const int  , const int  >>);
  static_assert(std::is_same_v<yk::forward_like_t<const int  , const int& >, std_fwd_like_t<const int  , const int& >>);
  static_assert(std::is_same_v<yk::forward_like_t<const int  , const int&&>, std_fwd_like_t<const int  , const int&&>>);
  static_assert(std::is_same_v<yk::forward_like_t<      int& , const int  >, std_fwd_like_t<      int& , const int  >>);
  static_assert(std::is_same_v<yk::forward_like_t<      int& , const int& >, std_fwd_like_t<      int& , const int& >>);
